...
if(swipe_choice.toLowerCase() == "right"){
  alert("She swiped right, too! It's a match! Now don't screw this up...");
}

else if(swipe_choice.toLowerCase() == "left"){
...
if(food_choice.toLowerCase() == "italian"){
 alert("Ah, molto bella!");
}

else if(food_choice.toLowerCase() == "curry"){
  alert("Curry on a first date!? What were you thinking? GAME OVER");
  throw "RiskyFoodError";
}

else if(food_choice.toLowerCase() == "pub grub"){
  alert("Lovely jubbly.");
}
...
if(pay_choice == "Offer to pay" && money_in_wallet >= 100){
...
switch(conversation_choice){
  case "I'd LOVE to listen to you talk about work.":
    alert("That's exactly what she wants to talk about! YOU WIN!");
    break;
  case "Sure, I'll take your Mum to the airport anytime.":
    alert("Helping out Mum? Always a good idea! YOU WIN!");
    break;
  case "I'm really into commitment.":
    alert("Precisely what every woman wants to hear! YOU WIN!");
    break;
  case "Please go out with me. I'm very lonely.":
